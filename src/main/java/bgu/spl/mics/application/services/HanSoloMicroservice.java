...
public class HanSoloMicroservice extends MicroService {
    ...
    /**
     * constructor. uses "Microservise's"  constructor.
     */
    ...
    /**
     * initialize HanSoloMicroservice with the behavior we want it to have.
    ...
    protected void initialize() {
        ...
        subscribeEvent(AttackEvent.class,(c)->{
            ...
            log.setHanSoloFinish(System.currentTimeMillis());
            log.setTotalAttacks();
        ...
        {
            log.setHanSoloTerminate(System.currentTimeMillis());
            terminate();
