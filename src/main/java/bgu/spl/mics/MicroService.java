...
public abstract class MicroService implements Runnable
{
    ...
    private String name;
    private HashMap<Class<? extends Message>,Callback>  funcSearch;
    ...
    {
        this.name=name;
        funcSearch=new HashMap<Class<? extends Message>,Callback>();
    ...
    {
        funcSearch.put(type,callback);// pairing event and callback and store it at the appropriate data structure.
    ...
    {
        funcSearch.put(type,callback);// pairing Broadcast and callback and store it at the appropriate data structure.
    ...
    protected final void terminate() {
        flag=false;//flag usage is signaling the run message loop to end.
    }
    ...
    public final void run()
    {
        ...
        while(flag)
        {
            try
            {
                Message msg = msgbus.awaitMessage(this);// could throw an exception if this is not registered at massegeBus.
                funcSearch.get(msg.getClass()).call(msg);
            }
